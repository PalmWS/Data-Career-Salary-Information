...
def InsertDataSalary():
    ...
    try:
        with open("D:\My office\Westride\Final Project\DataCareer_Salaries\Dataset\Data Career_salaries.csv") as csv_data:
            csv_reader = csv.reader(csv_data, delimiter=",")
            for row in csv_reader:
                cur.execute(
                    'INSERT INTO Data_Salary VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)', row)
